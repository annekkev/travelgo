...
public class ButtonPanel {
    ...
    private JPanel createSelectionPanel() {
        ...
        for (int index = 0; index < button.length; index++) {
            ...
            // button[index].setText(categories[index]); // Needed for API call but doesn't
            // look so good.
    ...
    /**
     * This method opens a new GUI window when user selects a category. It creates a
     * new FilterPanel object
